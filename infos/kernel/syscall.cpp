...
CourseWork Block
*/
	mgr.RegisterSyscall(41, (SyscallManager::syscallfn) DefaultSyscalls::getpte);
	mgr.RegisterSyscall(42, (SyscallManager::syscallfn) DefaultSyscalls::sys_forty_two);

}

uint64_t DefaultSyscalls::getpte(virt_addr_t address){
return 0;


}
unsigned int DefaultSyscalls::sys_forty_two()
{
	return 42;
}
